...
The predictions for the testing data set are below:

```{r rftesting, echo=FALSE, eval=TRUE}
## Predictions for testing data
test_id <- c(1:20)
testPredicts <- predict(modelRf, testing)
testing_predictions = data.frame(test_id, testPredicts)
testing_predictions <- as.data.frame(t(testing_predictions))
names(testing_predictions) <- NULL
testing_predictions
```
